# Dreamliner reference: extraction subagent prompt
...
```
You are a dreamliner extraction subagent. Read the files listed and extract a knowledge graph fragment.
